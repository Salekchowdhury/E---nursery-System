                    ...
                    <div class="card-body">
                        ...
                        <table id="sohag1" class="table table-bordered table-hover">
                            ...
                            <tbody class="tableBody attrTable">
                                    <?php
                                    $list = $datamanipulation->viewBuyersInfo();
                                    $count = 1;
                                    if ($list){
...
<script>
    ...
    $(".chatSendBtn").click(function () {
        ...
        var htmlstring = " ";
        var sellerDataCollectViaId = " ";
        formData.append("buyers_names",buyers_name);
        formData.append("buyers_ids",buyers_id);
        formData.append("sellers_ids",sellers_id);
        formData.append("sellers_names",sellers_name);
        formData.append("chat_messages",chat_message);
        formData.append("sellerActive",htmlstring);
