    ...
    <div class="content-wrapper">
        ...
        <div style="margin:20px ">
            ...
            if(isset($_GET['pay_id'])){
               ...
               $expertData = $datamanipulation->showBuyerDataById($id);
            }
            ?>
        </div>
        <div class="content">
                ...
                <div  class="col-md-6 " data-wow-duration= "0.5s" data-wow-delay = "0.5s">
                    <div class="card card-plain">
                        ...
                        <div style="border-radius: 8px; border: 2px solid; background-color: rgba(10,55,71,0.86);    border-color: #a71d2a; box-shadow: 5px 10px 10px 2px black" class="tab-pane ">
                            <form class="form-horizontal" action="../process/admin_process.php" method="post" >
                                ...
                                <div style="padding: 10px" class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input  disabled class="form-control" name="name" value="<?php echo $expertData->name?>">
                                            <input  type="hidden" class="form-control" name="name" value="<?php echo $expertData->name?>">
                                    ...
                                    <div class="col-6">
                                        <label  class="col-sm-6 col-form-label" style="color: white"><strong  >Expert Phone:</strong></label>
                                        <div class="col-sm-10">
                                            <input disabled class="form-control" name="phone" value="<?php echo $expertData->phone?>">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <label  class="col-sm-4 col-form-label" style="color: white"><strong  >Amount:</strong></label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="col-6">
                                        <label  class="col-sm-6 col-form-label"><strong  style="color: white">Transaction ID:</strong></label>
                                        <div class="col-sm-10">
                                            <input required class="form-control" name="transaction_id" value="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <label  class="col-sm-6 col-form-label"><strong  style="color: white">Bkash Number:</strong></label>
                                        <div class="col-sm-10">
                                            <input required class="form-control" name="phone" value="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <label  class="col-sm-6 col-form-label"><strong  style="color: white">Date:</strong></label>
                                        <div class="col-sm-10">
                                ...
                                <div class="row text-center">
                                    <div class="col-md-4">
                                        <div class="form-group" data-wow-duration= "0.5s" data-wow-delay = "0.5s" >
                                            <!-- <a href="change_profile.php?change_profile=<?php /*echo $email*/?>">Change Profile</a>-->
                                            <!-- <a href="#">Add Member</a>-->
                                            <a  href="salary.php" class="btn btn-info"  >Back</a>

                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group" data-wow-duration= "0.5s" data-wow-delay = "0.5s" style="font-size: 21px; background-color: #28a745 ; text-align: center;border: 2px  solid;border-radius: 25px; border-color: #3e19a7">
                                            <!-- <a href="change_profile.php?change_profile=<?php /*echo $email*/?>">Change Profile</a>-->
                                            <!-- <a href="#">Add Member</a>-->
                                            <button  style="border: none; outline: none; color: white ;background-color: #28a745" type="submit"  name="add_payment" >Pay</button>
