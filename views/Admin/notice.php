    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12" style="background-color: rgba(84,130,70,0.77); color: #0c525d">
                        <hr class="callout callout-info" style="background-color: #000b16; color: darkgrey">
                            <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="submit" name="add_notice" class="form-control btn btn-outline-light notice-submit " value="Add Notice">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <h5 style="color:greenyellow"> All Notice:</h5>
                            <?php
...
-->
                                    <div class=""> </div>
                                    <div class="col-6" style="color: yellow"> <?php echo $dateString?> (<span style="color: yellow; font-size: 18px"><?php echo "   ". date('h:i:s a' , strtotime($notice->time))?></span>)</div>
                                ...
                                <div style="white-space:pre-wrap;font-size: 17px; padding-left: 13px;color: white"><?php echo $note?></div>
