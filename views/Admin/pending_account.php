        ...
        <section class="content-header">
            ...
            <div class="col-12">
                <div class="card" style="background-color: rgba(10,55,71,0.86)">
                           <?php
                           $TotalPendingAccount=$datamanipulation->TotalPendingAccount();
                           $total=$TotalPendingAccount->total;
                           ?>
                    <div class="card-body">
                        <h3 style="color: white">Pending Account(<span style="font-size: 25px; color: #2ecc71"><?php echo $total?></span>)</h3>
                        <?php
                            ...
                            if($lists){
                                foreach ($lists as $list){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a style="color: white" href="../process/admin_process.php?confirmAccount=<?php echo $list->user_id?>"title="Confirm" class="btn  btn-success btn-outline-danger"><i class="fas fa-check-circle"></i> CONFIRM</a>
