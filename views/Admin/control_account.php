...
<div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="control_account.php" class="nav-link active">
        ...
        <section class="content-header">
            ...
            <div class="col-12">
                <div class="card" style="background-color: rgba(34,71,9,0.86)">
                    <?php
                    $TotalPendingAccount=$datamanipulation->TotalControlAccount();
                    $total=$TotalPendingAccount->total;
                    ?>
                    <div class="card-body">
                        <h3 style="color: white">Control Account(<span style="font-size: 25px; color: #2ecc71"><?php echo $total?></span>)</h3>
                        <?php
                        ...
                        <table id="sohag1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php
                             $lists=$datamanipulation->showAllUserData();
                             if($lists){
                                 foreach ($lists as $list){
                                     ...
                                     <tr>
                                         ...
                                         <td style="color: white"> <?php echo $list->position?></td>

                                         <td>
                                             <a style="color: white" href="../process/admin_process.php?deleteAccount=<?php echo $list->user_id?>"title="Delete" class="btn  btn-secondary btn-outline-danger"><i class="fas fa-trash" aria-hidden="true"></i> DELETE</a>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <div class="col-12">
                <div class="card" style="background-color: rgba(125,54,28,0.86)">
                    <?php
                    $TotalPendingAccount=$datamanipulation->TotalExpertAccount();
                    $total=$TotalPendingAccount->total;
                    ?>
                    <div class="card-body">
                        <h3 style="color: white">Expert Account(<span style="font-size: 25px; color: #2ecc71"><?php echo $total?></span>)</h3>
                        <?php
                        ...
                        <table id="sohag1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php
                            $lists=$datamanipulation->showAllExpertData();
                            if($lists){
                                foreach ($lists as $list){
                                    ?>
                                    <tr>
