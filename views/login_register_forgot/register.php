...
<div class="login-wrap">
        ...
        <div class="login-form">
            <div class="sign-in-htm">
                ...
                <div class="group">
                    ...
                    <input required name="name" placeholder=" Full Name....." style="width: 80%; height: 45px;  opacity: 1;border-radius: 15px;  border: none;
    ...
    outline: none;background-color: white;">
                         ...
                         <option value="Nursery_woner">Nursery Woner</option>
